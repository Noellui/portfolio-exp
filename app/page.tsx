...
export default function Home() {
  const skills = {
    production: ["Java", "Python", "MySQL", "JavaScript", "Linux (Ubuntu/Arch)", "Git"],
    learning: ["Next.js", "React", "WordPress Architecture", "Django", "Tailwind CSS"]
  };
  ...
  const projects = [
    {
      title: "Eco-News Portal",
      type: "WordPress Mini-Project",
      description: "A dynamic news hub featuring custom category filtering and SEO-optimized Astra architecture.",
      tech: ["WordPress", "Astra", "PHP"],
      link: "#"
    },
    {
      title: "Service Landing Page",
      type: "WordPress Mini-Project",
      description: "High-conversion landing page built with Elementor, featuring integrated Contact Form 7 and custom branding.",
      tech: ["Elementor", "CF7", "UI/UX"],
      link: "#"
    },
    {
      title: "Blood Donor Management",
      type: "Full-Stack Project",
      description: "A complete CRUD application for managing donor data, built as part of my college group project.",
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-[10px] px-2 py-0.5 rounded-full border ${
                    activity.status === 'Operational' ? 'border-emerald-500/30 text-emerald-400 bg-emerald-500/5' :
          ...
          {projects.map((project, index) => (
            <div key={index} className="group relative bg-slate-900/50 border border-slate-800 rounded-2xl p-6 hover:border-sky-500/50 transition-all duration-500 hover:shadow-[0_0_30px_rgba(14,165,233,0.1)]">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4">
                  <a href={project.link} className="inline-flex items-center gap-2 text-xs font-bold text-white group-hover:gap-3 transition-all">
          ...
          <div className="flex flex-col justify-between py-6">
            ...
            <div className="flex flex-col gap-6 pt-12 md:pt-0">
              ...
              <div className="flex items-center gap-6 justify-center md:justify-start">
                <a href="#" className="text-slate-600 hover:text-white transition-colors uppercase tracking-[0.2em] text-[10px]">GitHub_Repository</a>
